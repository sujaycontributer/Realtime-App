...
export default function Admin() {
  ...
  return (
    <div className='fixed top-0 left-0 md:left-[305px] w-full flex justify-center items-center bg-gray-200 h-screen p-4 text-black font-mono'>
      {message.length > 0 && <h1 className="text-green-400 text-4xl transition-all ease-in-out  fixed top-10">{message}</h1>}
        <div className='md:mr-[300px] flex flex-col items-center gap-4 p-4 w-[50%]'>
                 <div>
