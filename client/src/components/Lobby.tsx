...
export default function Lobby() {
  ...
  return (
    <div className='w-full h-screen flex justify-center items-center bg-gray-200  p-4 text-black font-mono'>
        <div className='flex flex-col items-center justify-center gap-4  p-4 w-[50%]'>
                 <div>
